...
async function main() {
    ...
    console.log(`placing order for ${(parseFloat(highestBid) + 0.01).toString()}`);
    await createOrder("buy", "XAIINR", parseFloat((parseFloat(highestBid) + 0.01).toFixed(3)), 10, Math.random().toString())
